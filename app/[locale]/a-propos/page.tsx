...
const Page = () => {
  return (
    <main>
      <section className="relative bg-[#f5f5f5] py-20 px-6 overflow-hidden">
        {/* Background Watermark Text */}
        <h1 className="absolute top-8 left-1/2 -translate-x-1/2 text-[120px] font-bold text-gray-200/60 whitespace-nowrap pointer-events-none select-none">
        ...
        <div className="relative max-w-6xl mx-auto text-center">
          ...
          {/* Intro */}
          <p className="text-[20px] leading-relaxed font-medium text-gray-800 max-w-6xl mx-auto">
          ...
          {/* Bullet Points */}
          <ul className="mt-8 space-y-4 text-[18px] text-black">
            <li>
              • Connaissance pointues de toutes les technologies du marché.
            </li>

            <li>
              • Offre de solution constamment mises à jour en fonction des
              nouvelles tendances & performance en termes de sécurité IT.
            </li>
            ...
            <li>
              • Sécuriser le flux d’information de tout utilisation, quelque
              soit le réseau et l’emplacement.
            </li>

            <li>
              • Sécurité & accélération avec la visibilité et le contrôle
              complets que les clients recherchent primordialement.
            </li>
          </ul>
        </div>
          </section>
