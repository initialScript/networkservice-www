      ...
      <div className='w-full max-w-md'>
        <div className='bg-white rounded-2xl shadow-2xl p-8 md:p-10 transition-all duration-300 hover:shadow-3xl'>
          ...
          <form className='space-y-5'>
            ...
            <button
              type='submit'
              className='w-full bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white font-semibold py-3 rounded-xl transition-all duration-200 transform hover:scale-[1.02] shadow-md hover:shadow-lg'
            >
              Se connecter
            </button>
          </form>
